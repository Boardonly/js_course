...
var tabResult = document.getElementById('table_result');
var preloader = document.getElementById('preloader'); // const controller = new UIController();
...
function getCardInfo(card) {
  ...
  return fetch("https://api.bincodes.com/cc/?format=json&api_key=d96ca493f5be297f8c304a87edcdf6a8&cc=".concat(card)).then(function (res) {
    return res.json();
  }).then(function (res) {
...
;
},{"mask-input":"node_modules/mask-input/lib/maskInput.js","./ui_controller":"ui_controller.js"}],"C:/Users/Yorik/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/module_3.e31bb0bc.map