...
function Footer(props) {
  ...
  }, "All")), _react.default.createElement("li", {
    onClick: function onClick() {
      return props.setFilter('active');
    }
  }, _react.default.createElement("a", {
    href: "#/active",
...
function Header(props) {
  ...
  return _react.default.createElement("header", {
    ...
    onClick: function onClick(props) {
      _this.props.onEdit(_this.props.id, {
        checked: event.target.checked
      });
    }
  }), _react.default.createElement("label", {
    for: "toggle-all"
  }, "Mark all as complete"), _react.default.createElement("div", {
    className: "loader"
  }));
}
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("li", {
        ...
        className: this.props.checked ? 'completed' : ''
        ...
        onChange: function onChange(event) {
          return _this2.props.onEdit(_this2.props.id, {
            checked: event.target.checked
          });
        }
      }), _react.default.createElement("label", null, this.props.value), _react.default.createElement("button", {
        className: "destroy",
        onClick: function onClick() {
          return _this2.props.onDelete(_this2.props.id);
        }
      })));
    }
  }]);
...
function (_React$Component2) {
  ...
  function ToDo() {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(ToDo).call(this));
    _this3.state = {
      list: [{
        id: '',
        checked: null,
    ...
    _this3.setFilter = _this3.setFilter.bind(_assertThisInitialized(_assertThisInitialized(_this3)));
    _this3.onDelete = _this3.onDelete.bind(_assertThisInitialized(_assertThisInitialized(_this3)));
    _this3.onCreate = _this3.onCreate.bind(_assertThisInitialized(_assertThisInitialized(_this3)));
    _this3.onEdit = _this3.onEdit.bind(_assertThisInitialized(_assertThisInitialized(_this3)));
    return _this3;
  }
  ...
  _createClass(ToDo, [{
    ...
    value: function onCreate(value) {
      this.setState({
        list: _toConsumableArray(this.state.list).concat([{
          id: Date.now(),
          checked: false,
          value: value
        }])
    ...
    value: function render() {
      ...
      return _react.default.createElement("section", {
        ...
        if (_this4.state.filter === 'active') {
          return !item.checked;
        }

        if (_this4.state.filter === 'completed') {
          return item.checked;
        }
...
_reactDom.default.render(_react.default.createElement(ToDo, null), document.getElementById('root'));
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js"}],"C:/Users/Yorik/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Yorik/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","index.jsx"], null)
//# sourceMappingURL=/lesson_26.78399e21.map